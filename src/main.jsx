...
const projects = [
  {
    ...
    image: '/Projects/Attention Is All You Need/Thumbnail.png',
    description: 'A research-focused project exploring the Transformer architecture behind modern language models.',
    features: ['Transformer architecture study', 'Self-attention concepts', 'NLP research implementation', 'Paper-to-code learning', 'LLM foundations'],
...
function WorkflowNode({ title, text, index }) {

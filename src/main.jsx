...
function ShopBuddyPage() {
  return (
    <main className="project-detail-page shopbuddy-page">
      ...
      <section className="project-detail-section" id="features">
        <div className="section-header">
          <h2 className="section-title">Features</h2>
          <p className="section-subtitle">More detailed project content will be added here next.</p>
        </div>
        <div className="detail-feature-grid">
          {['Multi-Agent AI Architecture', 'Intelligent Product Comparison', 'Price Normalization Across Platforms', 'AI-Powered Review Analysis', 'Transparent Recommendation Reasoning'].map((feature) => (
            <div className="detail-feature-card" key={feature}>{feature}</div>
          ))}
        </div>
      </section>
    </main>
